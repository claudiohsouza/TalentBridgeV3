  ...
  return (
    <div className="min-h-screen bg-cursor-background py-8 px-4 sm:px-6 lg:px-8 page-transition">
      <div className="max-w-7xl mx-auto">
        ...
        {error && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-8 fade-in" role="alert" style={{ animationDelay: '0.2s' }}>
        ...
        {jovens.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {jovens.map((jovem, index) => (
              <div 
                key={jovem.id} 
                className="card p-6 hover:border-cursor-primary transition-colors duration-300 cursor-pointer card-transition stagger-item"
